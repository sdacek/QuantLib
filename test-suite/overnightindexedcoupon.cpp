...
struct CommonVars {
    ...
    ext::shared_ptr<OvernightIndexedCoupon> makeCoupon(Date startDate,
                                                       ...
                                                       std::optional<Date> paymentDate = std::nullopt,
                                                       Real notional = 10000.0,
                                                       const DayCounter& daycounter = DayCounter(),
                                                       const Date exCouponDate = Date()) {
        return ext::make_shared<OvernightIndexedCoupon>(
            paymentDate.value_or(endDate), notional, startDate, endDate, sofr, 1.0, 0.0, Date(), Date(),
            daycounter, telescopicValueDates, averaging, fixingDays, lockoutDays, applyObservationShift,
            false, Date(), Date(), exCouponDate);
    }
...
BOOST_AUTO_TEST_CASE(testInterestCalculatedAccrualDateFixingHolidayAccruals) {
    ...
    const TestCase cases[] = {
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 0, false, 0, false, Date(), Date(),
            {
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 0, true, 0, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
                {Date(19, October, 2024), 1344.444444444},
                {Date(20, October, 2024), 2688.88888888},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 0, false, 4, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
                {Date(19, October, 2024), 1344.444444444},
                {Date(20, October, 2024), 2688.88888888},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 0, true, 4, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
                {Date(19, October, 2024), 1344.444444444},
                {Date(20, October, 2024), 2688.88888888},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 5, false, 0, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 5, true, 0, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
                {Date(19, October, 2024), 1338.888888888},
                {Date(20, October, 2024), 2677.777777777},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 5, false, 4, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
        ...
        {Date(18, October, 2024), Date(18, April, 2025), 5, true, 4, false, Date(), Date(),
            {
                {Date(18, October, 2024), 0.0},
                {Date(19, October, 2024), 1338.8888888887784},
                {Date(20, October, 2024), 2677.7777777775568},
        ...
        {Date(18, April, 2025), Date(19, May, 2025), 0, false, 0, false, Date(), Date(),
            {
        ...
        {Date(18, April, 2025), Date(19, May, 2025), 5, true, 0, true, Date(), Date(),
            {
                {Date(18, April, 2025), 0.0},
        ...
        {Date(18, April, 2025), Date(19, May, 2025), 0, false, 0, true, Date(), Date(),
            {
                {Date(18, April, 2025), 0.0},
        ...
        {Date(25, April, 2025), Date(27, May, 2025), 5, false, 0, false, Date(), Date(),
            {
        ...
        {Date(25, April, 2025), Date(27, May, 2025), 5, true, 0, false, Date(), Date(),
            {
                {Date(25, April, 2025), 0.0},
                {Date(26, April, 2025), 1200.0},
                {Date(27, April, 2025), 2400.0},
        ...
        {Date(14, April, 2025), Date(14, May, 2025), 0, false, 0, false, Date(), Date(),
            {
        ...
        {Date(14, April, 2025), Date(16, Jun, 2025), 0, false, 0, false, Date(11, Jun, 2025), Date(14, Jun, 2025),
            {
                {Date(14, April, 2025), 0.0},
                {Date(15, April, 2025), 1202.7777777778858},
                {Date(16, April, 2025), 2414.0345586420867},
        ...
        {Date(14, April, 2025), Date(16, Jun, 2025), 0, false, 1, false, Date(11, Jun, 2025), Date(14, Jun, 2025),
            {
                {Date(14, April, 2025), 0.0},
                {Date(15, April, 2025), 1202.7777777778858},
                {Date(16, April, 2025), 2414.0345586420867},
        ...
        {Date(14, April, 2025), Date(16, Jun, 2025), 0, false, 5, false, Date(11, Jun, 2025), Date(19, Jun, 2025),
            {
                {Date(14, April, 2025), 0.0},
                {Date(15, April, 2025), 1202.7777777778858},
                {Date(16, April, 2025), 2414.0345586420867},
        ...
        {Date(23, April, 2025), Date(23, Jun, 2025), 5, false, 0, false, Date(), Date(),
            {
                {Date(23, April, 2025), 0.0},
        ...
        {Date(23, April, 2025), Date(23, Jun, 2025), 5, true, 0, false, Date(10, Jun, 2025), Date(21, Jun, 2025),
            {
                {Date(23, April, 2025), 0.0},
                {Date(24, April, 2025), 1211.111111110160},
                {Date(25, April, 2025), 2408.478330246930},
        ...
        {Date(23, April, 2025), Date(23, Jun, 2025), 5, false, 5, false, Date(), Date(),
            {
                {Date(23, April, 2025), 0.0},
                {Date(24, April, 2025), 1211.111111110160},
                {Date(25, April, 2025), 2408.478330246930},
        ...
        {Date(23, April, 2025), Date(23, Jun, 2025), 5, true, 4, false, Date(10, Jun, 2025), Date(26, Jun, 2025),
            {
                {Date(23, April, 2025), 0.0},
                {Date(24, April, 2025), 1211.111111110160},
                {Date(25, April, 2025), 2408.478330246930},
        ...
        {Date(26, Mar, 2027), Date(28, Jun, 2027), 0, false, 0, false, Date(), Date(),
            {
        ...
        {Date(26, Feb, 2027), Date(26, Mar, 2027), 0, false, 1, false, Date(25, Mar, 2027), Date(26, Mar, 2027),
            {
    ...
    const auto makeCoupon = [&](const TestCase& tc, bool telescopicValueDates) {
        auto dc = tc.diffDaycounter ? Actual365Fixed() : vars.sofr->dayCounter();
...
BOOST_AUTO_TEST_CASE(testErrorWhenCurveNullOrTooNarrow) {
    ...
    auto today = Date(26, March, 2026);
    CommonVars vars(today);
...
BOOST_AUTO_TEST_CASE(testAccruedAmountTradingExCouponAfterAccrualEndDate) {
    ...
    auto coupon = vars.makeCoupon(Date(31, March, 2026), Date(31, March, 2027), 0, 0, false, true,
                                  RateAveraging::Compound, Date(2, April, 2027), 1.0, DayCounter(), exCpnDate);
